<?php
/*
 * ###################################### eWebEditor V10.3 - Advanced online web based WYSIWYG HTML editor. Copyright (c) 2003-2015 eWebSoft.com For further information go to http://www.ewebeditor.net/ This copyright notice MUST stay intact for use. ######################################
 */
require ("private.php");
...
function ShowConfig() {
    ...
    $n_StyleID = 8; // edit by mjf 2016-2-17
